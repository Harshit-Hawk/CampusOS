...
import { getMyCertificates, uploadCertificate, deleteCertificate } from '@/actions/certificate-repo'
...
export default function CertificatesPage() {
  ...
  return (
    <DashboardContainer title="Certificate Repository" description="Upload and showcase your certifications">
      {/* Actions Bar */}
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-medium hover:opacity-90 transition-opacity shrink-0"
        >
      ...
      {loading ? (
        ...
        <div className="text-center py-16">
          ...
          <p className="text-sm text-[hsl(var(--muted-foreground))] mb-4">
            Upload your certifications from platforms like Google, AWS, Coursera, and more.
          </p>
          <button
            onClick={() => setShowUploadModal(true)}
            className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm font-medium"
          >
          ...
          {filteredCerts.map((cert, i) => {
            ...
            return (
              <motion.div
                ...
                className="group p-5 rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] card-hover"
              >
                ...
                {/* Actions */}
                <div className="flex items-center gap-2 pt-3 border-t border-[hsl(var(--border)/0.5)]">
                  {cert.credential_url && (
                    <a
    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Upload Certificate">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex justify-end gap-3 pt-2">
          <button type="button" onClick={onClose} className="px-4 py-2 rounded-xl text-sm font-medium text-[hsl(var(--muted-foreground))] hover:bg-[hsl(var(--muted))]">
            Cancel
          </button>
          <button
