...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-[500px] h-[500px] rounded-full bg-[hsl(221_83%_53%/0.08)] blur-[100px] animate-float" />
      <div className="fixed bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-[hsl(263_70%_50%/0.08)] blur-[100px] animate-float" style={{ animationDelay: '1.5s' }} />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight">
            Campus<span className="text-transparent bg-clip-text gradient-primary bg-gradient-to-r from-blue-500 to-sky-500">OS</span>
          </h1>
          <p className="text-[hsl(var(--muted-foreground))] mt-2">Welcome back to your campus community</p>
        </div>
