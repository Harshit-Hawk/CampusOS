        ...
        <form action={handleSubmit} className="space-y-4" id="create-event-form">
          ...
          <div className="flex items-center gap-6 pt-2 flex-wrap">
            ...
            <div className="flex items-center gap-3">
              <input
                type="checkbox"
                id="require_daily_attendance"
                name="require_daily_attendance"
                className="w-4 h-4 rounded border-[hsl(var(--border))] text-blue-500 focus:ring-blue-500/20 bg-[hsl(var(--muted))]"
              />
              <label htmlFor="require_daily_attendance" className="text-sm font-medium text-[hsl(var(--foreground))] select-none cursor-pointer">
                Require Daily Attendance (Check-in/out)
              </label>
            </div>
